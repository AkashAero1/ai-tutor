...
FALLBACK = "The student made a mistake. The correct explanation involves identifying the error, explaining why it is wrong, and providing the correct method with proper reasoning and examples."
